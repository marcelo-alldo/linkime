    ...
    <ClickAwayListener onClickAway={() => setPanelOpen(false)}>
      <Root className={clsx('flex h-full flex-auto', className)}>
        <div id="fuse-navbar-side-panel" className="flex shrink-0 flex-col items-center h-full">
          <img className="my-8 w-11" src="/assets/images/logo/alldo-sem-fundo.png" alt="logo" />
        ...
        {selectedNavigation.length > 0 && (
          ...
          >
            <FuseNavigation className={clsx('navigation')} navigation={selectedNavigation} layout="vertical" onItemClick={handleChildItemClick} />
          </StyledPanel>
        )}
      </Root>
    </ClickAwayListener>
