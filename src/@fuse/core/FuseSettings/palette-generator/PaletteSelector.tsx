    ...
    <>
      ...
      >
                ...
                render={({ field: { onChange: _onChange, value: _value } }) => (
                  <TextField
                    ...
                    onChange={(ev) => {
                      ...
                      setValue('palette.primary.contrastText', theme.palette.getContrastText(ev.target.value), { shouldDirty: true });
                    }}
                    type="color"
                    variant="outlined"
                    className="mb-8"
                ...
                render={({ field: { onChange: _onChange, value: _value } }) => (
                  <TextField
                    ...
                    onChange={(ev) => {
                      ...
                      setValue('palette.secondary.contrastText', theme.palette.getContrastText(ev.target.value), { shouldDirty: true });
                    }}
                    type="color"
                    variant="outlined"
                    className="mb-8"
        ...
        <DialogActions className="flex justify-between p-4">
          ...
          <Button variant="contained" color="secondary" autoFocus onClick={handleSubmit(onSubmit)} disabled={_.isEmpty(dirtyFields) || !isValid}>
            Save
          </Button>
        </DialogActions>
      </Dialog>
