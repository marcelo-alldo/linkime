...
function FuseNavHorizontalItem(props: FuseNavHorizontalItemProps) {
  ...
  const memoizedContent = useMemo(
    () => (
      <Root component={component} className={clsx('fuse-list-item', item.active && 'active')} sx={item.sx} {...itemProps}>
        {item.icon && (
        ...
        <ListItemText className="fuse-list-item-text" primary={item.title} classes={{ primary: 'text-md fuse-list-item-text-primary truncate' }} />
