              ...
              <PaletteSelector
                ...
                triggerElement={
                  <div className="group m-2 flex w-32 cursor-pointer flex-col items-center space-y-2">
                    ...
                    <Typography className="mb-6 flex-1 text-base font-semibold opacity-80 group-hover:opacity-100">Main Palette</Typography>
                  </div>
                }
              />
            )}
              ...
              <PaletteSelector
                ...
                triggerElement={
                  <div className="group m-2 flex w-32 cursor-pointer flex-col items-center space-y-2">
                    ...
                    <Typography className="mb-6 flex-1 text-base font-semibold opacity-80 group-hover:opacity-100">Navbar Palette</Typography>
                  </div>
                }
              />
            )}
              ...
              <PaletteSelector
                ...
                triggerElement={
                  <div className="group m-2 flex w-32 cursor-pointer flex-col items-center space-y-2">
                    ...
                    <Typography className="mb-6 flex-1 text-base font-semibold opacity-80 group-hover:opacity-100">Toolbar Palette</Typography>
                  </div>
                }
              />
            )}
              ...
              <PaletteSelector
                ...
                triggerElement={
                  <div className="group m-2 flex w-32 cursor-pointer flex-col items-center space-y-2">
                    ...
                    <Typography className="mb-6 flex-1 text-base font-semibold opacity-80 group-hover:opacity-100">Footer Palette</Typography>
                  </div>
                }
              />
            )}
