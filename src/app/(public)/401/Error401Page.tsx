...
function Error401Page() {
  const { isGuest, data: user } = useUser();
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center p-4">
      <div className="w-full max-w-5xl text-center">
        ...
        >
          <Typography variant="h5" color="text.secondary" className="mt-2 text-center text-lg font-medium tracking-tight md:text-xl">
            Você não tem permissão para acessar esta página.
          </Typography>
        </motion.div>
        {!isGuest ? (
          <Link className="mt-12 block font-normal" to={user?.data?.loginRedirectUrl || '/'}>
