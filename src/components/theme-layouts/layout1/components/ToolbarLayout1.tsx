      ...
      >
        <Toolbar className="min-h-12 p-0 md:min-h-16">
              ...
              <>
                {!isMobile && (
                  <>
                    ...
                    {config.navbar.style === 'style-1' && !navbar.open && <NavbarToggleButton className="h-10 w-10 p-0" />}
                  </>
                )}
          ...
          <div className="flex items-center overflow-x-auto px-2 md:px-4 space-x-1.5">
            ...
            <FullScreenToggle />
            <LightDarkModeToggle
              lightTheme={_.find(themeOptions, { id: import.meta.env.VITE_APP_THEME_DEFAULT || 'default' })}
              darkTheme={_.find(themeOptions, { id: import.meta.env.VITE_APP_THEME_DEFAULT_DARK || 'defaultDark' })}
            />
            {/* <NavigationSearch /> */}
          ...
          {config.navbar.display && config.navbar.position === 'right' && (
            <>
              {!isMobile && (
                <>
                  {(config.navbar.style === 'style-3' || config.navbar.style === 'style-3-dense') && <NavbarToggleButton className="h-10 w-10 p-0" />}
