...
class FuseNavigationHelper {
  ...
  static appendNavItem(nav: FuseNavItemType[], item: FuseNavItemType, parentId: string | null = null): FuseNavItemType[] {
    if (!parentId) {
      return [...nav, item];
    }
  ...
  static prependNavItem(nav: FuseNavItemType[], item: FuseNavItemType, parentId: string | null = null): FuseNavItemType[] {
    if (!parentId) {
      return [item, ...nav];
    }
